    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                $result = Order::save($nameFull, $email, $phone, $productsInCart);

                if ($result) {
                    // Если заказ успешно сохранен
                    // Оповещаем администратора о новом заказе по почте
                    $adminEmail = 'support@gmail.com';
                    $message = '<a href="http://cozyhome.local/admin/orders">Список заказов</a>';
                    $subject = 'Новый заказ!';
