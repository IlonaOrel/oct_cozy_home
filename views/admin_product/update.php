            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <img src="<?=Product::getImage($product['id']); ?>" width="200" alt="Photo product" />
                        <input type="file" name="image" placeholder="" value="<?=$product['image']; ?>">
                        <p>Общее описание</p>
                        <textarea name="general_description"><?= $product['general_description']; ?></textarea>
                        <p>Характеристика</p>
                        <textarea name="list_detal"><?= $product['list_detal']; ?></textarea>
                        <br/><br/>
                        <p>Рекомендуемые</p>
